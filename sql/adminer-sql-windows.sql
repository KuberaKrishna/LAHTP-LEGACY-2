-- have changed encoding for windows
SET NAMES utf8;
SET time_zone = '+00:00';
...
CREATE TABLE `Posters_Table` (
  ...
  `Poster` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `PosterName` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `PosterPrice` varchar(64) NOT NULL,
  `PosterFile` varchar(256) NOT NULL,
  `CouponCode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
